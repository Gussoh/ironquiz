...
public class OldServer {
 ...
 //   private ServerConfig config = new ServerConfig(); // TODO Read config from file
    ...
    private TreeMap<Integer,Pulpet> pulpets = new TreeMap<Integer,Pulpet>();
...
/*            
    private OldServer() {
        ...
        for (;;) {
            ...
            // Remove so it would compile new ClientHandler(this, client).start(); 
    ...
    public void removePulpetConnection(ClientHandler clientHandler) {
        for(Map.Entry<Integer,Pulpet> pulpet : pulpets.entrySet()) {
...
// Remove so it would compile             clientHandler.writeObject(object);
        }
    }
